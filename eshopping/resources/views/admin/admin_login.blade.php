					...
					<form class="form-horizontal" action="{{url('/admin_dashboard')}}" method="post">
						...
						<fieldset>
							...
							<div class="input-prepend" title="Adminemail">
								...
								<input class="input-large span10" name="admin_email" id="adminemail" type="text" placeholder="type email address"/>
							</div>
							<div class="clearfix"></div>

							<div class="input-prepend" title="AdminPassword">
								<span class="add-on"><i class="halflings-icon lock"></i></span>
								<input class="input-large span10" name="admin_password" id="adminpassword" type="password" placeholder="type password"/>
							</div>
							<div class="clearfix"></div>
