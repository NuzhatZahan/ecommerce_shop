...
<head>
	...
	<!-- start: Favicon -->
	<link rel="shortcut icon" href="{{url('backend/img/favicon.ico')}}">
	<!-- end: Favicon -->
                ...
                <div id="sidebar-left" class="span2">
                    <div class="nav-collapse sidebar-nav">
                        <ul class="nav nav-tabs nav-stacked main-menu">
                            ...
                            <li><a href="{{url('/all_category')}}"><i class="icon-envelope"></i><span class="hidden-tablet"> All Category </span></a></li>
                            <li><a href="{{url('/add_category')}}"><i class="icon-tasks"></i><span class="hidden-tablet"> Add Category</span></a></li>
                            <li><a href="{{url('/all_brands')}}"><i class="icon-eye-open"></i><span class="hidden-tablet"> All Brands</span></a></li>
                            <li><a href="{{url('/add_brands')}}"><i class="icon-dashboard"></i><span class="hidden-tablet"> Add Brands</span></a></li>
